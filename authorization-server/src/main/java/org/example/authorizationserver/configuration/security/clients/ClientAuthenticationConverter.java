package org.example.authorizationserver.configuration.security.clients;

import jakarta.servlet.http.HttpServletRequest;
import org.example.authorizationserver.configuration.security.AuthorizationGrantType;
...
public class ClientAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        return new OAuth2AccessTokenAuthenticationToken(null, null, null);
    }
